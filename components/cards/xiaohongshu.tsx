...
export function XiaohongshuCard() {
   ...
   return (
      <MotionLink
         ...
         className="card-border relative col-span-2 row-span-1 flex items-center justify-center gap-x-2 overflow-hidden rounded-xl text-white md:col-span-1 md:col-start-4 md:row-span-1 md:row-start-3"
